...
##
## Description:   Calculating the inverse of a matrix can be very time and
##                resource consuming. Therefor it can be beneficial to
##                store the inverse of a matrix in cache instead of
##                calculating the inverse repeatedly.
##                The assignment is to create two functions that are 
##                designed to do that.
...
## Description:   Creates an object that is able to store and retrieve 
##                an inverse matrix from cache.
## Arguments:     The function has one argument:
##                      x     The matrix you wish to invert.
## Returns:       Returns a special "matrix", which is really a list 
...
makeCacheMatrix <- function(x = matrix()) {        
      ...
      # Create set function that: stores in cache the matrix value and 
      # sets the inverse matrix value in cache to NULL.
      set <- function(y) {
            x <<- y
            inverse.x <<- NULL
      }
      ...
      # Create setinverse function that: stores the inverse matrix value 
      # in cache.
...
## Funtion:       cacheSolve
## Description:   Calculates the inverse of the special "Matrix" created  
##                with the makeCacheMatrix function. However, it first 
...
##                            solve function
## Returns:       Returns the inverse of the matrix that was used as input
##                for the makeCacheMatrix function. If the inverse was 
##                retrieved from cache, "Getting cached data" is printed
##                along with the inverse matrix.
